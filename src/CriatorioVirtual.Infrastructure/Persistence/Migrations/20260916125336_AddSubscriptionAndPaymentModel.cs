        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_subscriptions_charge_due_matches_status", "(\"Status\" = 1 AND \"NextChargeDueAtUtc\" IS NULL) OR (\"Status\" IN (2, 4) AND \"NextChargeDueAtUtc\" = \"TrialEndsAtUtc\") OR (\"Status\" = 3 AND \"NextChargeDueAtUtc\" > \"TrialEndsAtUtc\")");
                    ...
                    table.CheckConstraint("ck_subscriptions_grace_period_dates_consistent", "(\"Status\" = 4 AND \"GracePeriodStartedAtUtc\" IS NOT NULL AND \"GracePeriodEndsAtUtc\" IS NOT NULL AND \"GracePeriodEndsAtUtc\" - \"GracePeriodStartedAtUtc\" = INTERVAL '168 hours') OR (\"Status\" <> 4 AND \"GracePeriodStartedAtUtc\" IS NULL AND \"GracePeriodEndsAtUtc\" IS NULL)");
                    table.CheckConstraint("ck_subscriptions_plan_code_not_blank", "btrim(\"PlanCode\") <> ''");
                    ...
                    table.CheckConstraint("ck_subscriptions_trial_duration_exact", "\"TrialStartedAtUtc\" IS NULL OR \"TrialEndsAtUtc\" - \"TrialStartedAtUtc\" = INTERVAL '168 hours'");
                    table.CheckConstraint("ck_subscriptions_trial_requires_gateway_confirmation", "(\"Status\" = 1 AND \"GatewaySubscriptionId\" IS NULL AND \"TrialStartedAtUtc\" IS NULL) OR (\"Status\" IN (2, 3, 4) AND \"GatewaySubscriptionId\" IS NOT NULL AND \"TrialStartedAtUtc\" IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_payments_gateway_payment_id_not_blank", "btrim(\"GatewayPaymentId\") <> ''");
