...
{
    /// <inheritdoc />
    public partial class AllowSubscriptionCancellation : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddCheckConstraint(
                ...
                schema: "app",
                table: "subscriptions",
                sql: "(\"Status\" = 1 AND \"NextChargeDueAtUtc\" IS NULL) OR (\"Status\" IN (2, 4) AND \"NextChargeDueAtUtc\" = \"TrialEndsAtUtc\") OR (\"Status\" = 3 AND \"NextChargeDueAtUtc\" > \"TrialEndsAtUtc\")");

            migrationBuilder.AddCheckConstraint(
                name: "ck_subscriptions_grace_period_dates_consistent",
                schema: "app",
                table: "subscriptions",
                sql: "(\"Status\" = 4 AND \"GracePeriodStartedAtUtc\" IS NOT NULL AND \"GracePeriodEndsAtUtc\" IS NOT NULL AND \"GracePeriodEndsAtUtc\" - \"GracePeriodStartedAtUtc\" = INTERVAL '168 hours') OR (\"Status\" <> 4 AND \"GracePeriodStartedAtUtc\" IS NULL AND \"GracePeriodEndsAtUtc\" IS NULL)");
            ...
            migrationBuilder.AddCheckConstraint(
                ...
                schema: "app",
                table: "subscriptions",
                sql: "(\"TrialStartedAtUtc\" IS NULL AND \"TrialEndsAtUtc\" IS NULL AND \"NextChargeDueAtUtc\" IS NULL) OR (\"TrialStartedAtUtc\" IS NOT NULL AND \"TrialEndsAtUtc\" IS NOT NULL AND \"NextChargeDueAtUtc\" IS NOT NULL AND \"TrialEndsAtUtc\" > \"TrialStartedAtUtc\" AND \"NextChargeDueAtUtc\" >= \"TrialEndsAtUtc\")");

            migrationBuilder.AddCheckConstraint(
                name: "ck_subscriptions_trial_requires_gateway_confirmation",
                schema: "app",
                table: "subscriptions",
                sql: "(\"Status\" = 1 AND \"GatewaySubscriptionId\" IS NULL AND \"TrialStartedAtUtc\" IS NULL) OR (\"Status\" IN (2, 3, 4) AND \"GatewaySubscriptionId\" IS NOT NULL AND \"TrialStartedAtUtc\" IS NOT NULL)");
        }
    }
}
