...
public static class PersistenceServiceCollectionExtensions
{
        ...
        X509Certificate2 dataProtectionCertificate)
    {
        ...
        services.AddScoped<
            ...
            SimulateHomologationSubscriptionCommandHandler>();
        services.AddScoped<
        ...
        services.AddScoped<IQueryHandler<ListCompetitionsQuery, ListCompetitionsResult>, ListCompetitionsQueryHandler>();
        ...
        services.AddScoped<AcceptInternalTransferSession>();
        services.AddScoped<ICommandFailureCompensator>(serviceProvider =>
            serviceProvider.GetRequiredService<AcceptInternalTransferSession>());
        ...
        services.AddScoped<IQueryHandler<GetAccessContextQuery, AccessContextResult?>, GetAccessContextQueryHandler>();
